...
# not thread-safe. On RHEL and Rocky, PHP comes from the Remi repository.
...
# P4 Search runs against Elasticsearch. Disabled by default: its requirement
# of 4 vCPU and 8 GB RAM per component exceeds the size of dev and stage.
...
# Swarm supports the prefork MPM only; worker and event will not work.
